...
export default function CartProductCard({
  ...
  const [totalPriceItem, setTotalPriceItem] = useState<number>(productPrice);



  useEffect(()=>{

    const newPrice = productPrice * stateQuantity
    setTotalPriceItem(newPrice)
    updateSubtotal(newPrice)
    console.log('newPrice', newPrice)
    return () => updateSubtotal(productPrice)
  },[stateQuantity])
